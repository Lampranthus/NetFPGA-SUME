...
//               /home/luisfercrtez/Documents/Master/Tesis/NetFPGA-SUME/firmware/verilog-pcie-master/example/ExaNIC_X10/fpga/fpga/fpga.gen/sources_1/ip/pcie3_ultrascale_0/pcie3_ultrascale_0_stub.v
...
module pcie3_ultrascale_0(pci_exp_txn, pci_exp_txp, pci_exp_rxn, 
  ...
  cfg_interrupt_int, cfg_interrupt_pending, cfg_interrupt_sent, 
  cfg_interrupt_msi_function_number, cfg_interrupt_msix_enable, 
  ...
  cfg_interrupt_msix_sent, cfg_interrupt_msix_fail, cfg_hot_reset_out, 
...
/* synthesis syn_force_seq_prim="sys_clk_gt" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie3_cfg_msix:1.0 pcie3_cfg_msix enable" *) (* X_INTERFACE_MODE = "slave" *) output [3:0]cfg_interrupt_msix_enable;
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie3_cfg_msix:1.0 pcie3_cfg_msix mask" *) output [3:0]cfg_interrupt_msix_mask;
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie3_cfg_msix:1.0 pcie3_cfg_msix vf_enable" *) output [7:0]cfg_interrupt_msix_vf_enable;
  (* X_INTERFACE_INFO = "xilinx.com:interface:pcie3_cfg_msix:1.0 pcie3_cfg_msix vf_mask" *) output [7:0]cfg_interrupt_msix_vf_mask;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.sys_clk_gt CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.sys_clk_gt, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0" *) input sys_clk_gt /* synthesis syn_isclock = 1 */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:display_pcie3_ultrascale:int_shared_logic:1.0 pcie3_us_int_shared_logic ints_qpll1lock_out" *) (* X_INTERFACE_MODE = "master" *) output [1:0]int_qpll1lock_out;
