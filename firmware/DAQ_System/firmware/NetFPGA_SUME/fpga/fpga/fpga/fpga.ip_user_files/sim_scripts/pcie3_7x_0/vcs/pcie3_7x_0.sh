...
#
# Script generated by Vivado on Thu Sep 04 12:45:28 MST 2025
...
#
# Usage        : pcie3_7x_0.sh
#                pcie3_7x_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie3_7x_0.sh [-reset_run]
#                pcie3_7x_0.sh [-reset_log]
#                pcie3_7x_0.sh [-help]
#
...
#                script (type 'pcie3_7x_0.sh -help' for more information).
#
...
# script info
echo -e "pcie3_7x_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie3_7x_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pcie3_7x_0 xil_defaultlib.glbl -o pcie3_7x_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pcie3_7x_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luisfercrtez/Documents/Master/Tesis/NetFPGA-SUME/firmware/DAQ_System/firmware/NetFPGA_SUME/fpga/fpga/fpga/fpga.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key pcie3_7x_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pcie3_7x_0_simv.daidir vcs_lib c.obj)
...
Usage: pcie3_7x_0.sh [-step]\n\
Usage: pcie3_7x_0.sh [-lib_map_path]\n\
Usage: pcie3_7x_0.sh [-reset_run]\n\
Usage: pcie3_7x_0.sh [-reset_log]\n\
Usage: pcie3_7x_0.sh [-keep_index]\n\
