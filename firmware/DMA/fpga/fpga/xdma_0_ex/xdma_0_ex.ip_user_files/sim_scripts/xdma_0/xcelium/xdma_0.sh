...
#
# Script generated by Vivado on Fri Sep 05 17:35:53 MST 2025
...
#
# Usage        : xdma_0.sh
#                xdma_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xdma_0.sh [-reset_run]
#                xdma_0.sh [-reset_log]
#                xdma_0.sh [-help]
#
...
#                script (type 'xdma_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_9 -libname xdma_v4_1_31 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib blk_mem_gen_v8_4_9 xdma_v4_1_31)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "xdma_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xdma_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xdma_v4_1_31 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/xdma_v4_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xdma_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xdma_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xdma_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: xdma_0.sh [-step]\n\
Usage: xdma_0.sh [-lib_map_path]\n\
Usage: xdma_0.sh [-reset_run]\n\
Usage: xdma_0.sh [-reset_log]\n\
Usage: xdma_0.sh [-keep_index]\n\
