...
#
# Script generated by Vivado on Fri Sep 05 17:35:51 MST 2025
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
