...
# set xvlog options
xvlog_opts="--incr --relax  -L xdma_v4_1_31 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_1 xil_defaultlib.blk_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
