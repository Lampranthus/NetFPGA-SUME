...
#
# Script generated by Vivado on Fri Sep 05 17:31:20 MST 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_9 -libname xdma_v4_1_31 -libname unisims_ver -libname unimacro_ver -libname secureip"
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luisfercrtez/Documents/Master/Tesis/NetFPGA-SUME/firmware/DMA/fpga/fpga/fpga/fpga.cache/compile_simlib/xcelium"
  fi
